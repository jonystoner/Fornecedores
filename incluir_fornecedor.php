...
<body style="background-color: black">
    <div>
        <div class="col">
            ...
            include "menu.php";
            ?>
            <form class="container-fluid mt-5" action="salvar.php" method="POST">
                <div class="form-row">
                    <div class="form-group col-12 col-md-6 col-lg-4 text-white">
                        <label for="nome_fornecedor">Nome Fornecedor</label>
                        <input type="text" class="form-control" id="nome_fornecedor" name="nome_fornecedor" placeholder="Nome Fornecedor" required>
                    </div>
                    <div class="form-group col-12 col-md-6 col-lg-4 text-white">
                        <label for="cpf_cnpj">CPF ou CNPJ</label>
                        <input type="text" class="form-control cpfOuCnpj" id="cpf_cnpj" name="cpf_cnpj" placeholder="cpf_cnpj" required>
                    </div>
                </div>
                <div class="form-row">
